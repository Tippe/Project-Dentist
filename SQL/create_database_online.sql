...
--
-- Machine: 127.0.0.1
-- Gegenereerd op: 23 okt 2017 om 13:37
-- Serverversie: 5.6.17
-- PHP-versie: 5.5.12
...
--
-- Databank: `codeaddict_db`
--
CREATE DATABASE IF NOT EXISTS `codeaddict_db` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `codeaddict_db`;
